...
public class EasingProperty {
    public static final Duration animationDuration = Duration.millis(15);
    protected static final double easeInInitialRate = 0.01;
    protected static final double minUnit = 0.001;
    protected static final double motionBlurStrength = 100;
    protected static final double absoluteMinUnit = 1e-10;
    protected static double maxRate = 0.07;
    ...
    public EasingProperty(DoubleProperty valueProcessed) {
        keyFrame = new KeyFrame(animationDuration, new KeyFrameHandler());
        blur = new MotionBlur(0.0,0.0);
